...
// 이미 정수형 데이터를 4개를 저장하는 메모리 공간을 빌렸으므로 None이나 Null은 정수형이 아니며 삭제는 불가능하다

// 동적배열: 객체
// 사용자 입장에서는 상황에 따라 크기가 변한다
// 내부적으로는 정적 배열이 꽉 차게 되면
// 2배 정도의 크기의 정적 배열을 다시 메모리(힙)에 확보하고
// 값을 전부 복사해서 사용
...
// 그 다음에 인덱스 3에 있는 7을 지우는 게 아니라 내부적으로
